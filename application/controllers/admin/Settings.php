...
class Settings extends Admin_Controller
{
    ...
    function index()
    {
        ...
        if ($vals = $this->input->post()) {
            ...
            unset($vals['sec6_order_no'],$vals['sec6_title'], $vals['sec6_link']);
            $this->master->delete_where('multi_text', array('section'=> 'header-sec','site_lang'=> 'eng'));
            $sec6s = array('order_no' => $sec6['order_no'], 'title' => $sec6['title'], 'txt1' => $sec6['text1']);
            
            $num=$sec6['title'];

            saveFields( 'header-sec', $sec6s,$num, 'eng');
