<?php if ($this->uri->segment(3) == 'manage'): ?>
    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= site_url(ADMIN . '/categories'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
    <div>
        <hr>
    ...
    <?php else: ?>
        ...
        <div class="row margin-bottom-10">
            <div class="col-md-6">
                <h2 class="no-margin"><i class="entypo-list"></i> Furniture Categories</h2>
            </div>
            <div class="col-md-6 text-right">
                    ...
                    <?php foreach ($rows as $row): ?>
                        <tr class="odd gradeX">
                            ...
                            <td class="text-center">
                                <a href="<?= site_url(ADMIN.'/categories/manage/'.$row->id); ?>">Edit</a> |
                                <a href="<?= site_url(ADMIN.'/categories/delete/'.$row->id); ?>" onclick="return confirm('Your are about to delete this FAQ. Press OK to continue.');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
