...
<table class="table table-bordered datatable" id="table-1">
    ...
    <tbody>
        ...
        <tr  class="odd gradeX status_tr">
            ...
            <td class="text-left"><strong>About Us</strong></td>
            <td class="text-left">Page</td>
            <td class="text-center">
                <div class="btn-group">
        ...
        <tr  class="odd gradeX status_tr">
            ...
            <td class="text-left"><strong>Contact Us</strong></td>
            <td class="text-left">Page</td>
            <td class="text-center">
                <div class="btn-group">
        ...
        <tr  class="odd gradeX status_tr">
            ...
            <td class="text-left"><strong>Privacy Policy</strong></td>
            <td class="text-left">Page</td>
            <td class="text-center">
                <div class="btn-group">
        ...
        <tr  class="odd gradeX status_tr">
            ...
            <td class="text-left"><strong>My Account</strong></td>
            <td class="text-left">Page</td>
            <td class="text-center">
                <div class="btn-group">
                    <a href="<?= base_url(ADMIN) ?>/sitecontent/contact" class="btn btn-primary"> <i class="glyphicon glyphicon-edit" style="color: #fff" aria-hidden="true"></i> Edit Page </a>
