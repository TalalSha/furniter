        ...
        <div class="form-group">
                <div class="row">
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title">
                                     Banner Image <br>Notes: Image dimention : 1903px x 300px
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="control-label">Banner Heading <span style="color: red">*</label>
                    ...
                    <!-- <div class="col-md-6">
                        ...
                        <label class="control-label">Banner Tagline <span style="color: red">*</label>

                        <input type="text" name="banner_tagline" id="banner_tagline" value="<?= $row['banner_tagline'] ?>" class="form-control" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label for="section2_left_tagline" class="control-label"> Description  <span class="symbol required">*</span></label>
                                <textarea name="section2_left_tagline" class="form-control ckeditor" required="required" rows="3"><?php echo $row['section2_left_tagline']; ?></textarea>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label for="fifth_field_heading" class="control-label"> Fourth Field Heading  <span class="symbol required">*</span></label>
